# Retrieved from https://doc.qt.io/qtforpython/examples/example_widgets_itemviews_jsonmodel.html. GNU 1.3. The Qt Company Ltd.
...
class JsonModel(QAbstractItemModel):
    ...
    def __init__(self, document: dict = None, parent: QObject = None):
...
if __name__ == "__main__":
    ...
    json_path = QFileInfo(__file__).absoluteDir().filePath(r"C:\Users\sstucker\Documents\EventsTool\test\output\sub-01_task-tapping_events.json")
